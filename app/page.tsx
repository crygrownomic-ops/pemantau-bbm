            ...
            <div className="pt-3">
              ...
              {isKelolaOpen && (
                <div className="mt-1 pl-3 space-y-1 border-l-2 border-slate-700 ml-2">
                  <Link href="/admin/settings?tab=drivers" className="block px-3 py-1.5 text-xs text-slate-300 hover:text-amber-400 font-medium">
                    • Master Driver
                  </Link>
                  <Link href="/admin/settings?tab=vehicles" className="block px-3 py-1.5 text-xs text-slate-300 hover:text-amber-400 font-medium">
                    • Master Armada
                  </Link>
                  <Link href="/admin/settings?tab=prices" className="block px-3 py-1.5 text-xs text-slate-300 hover:text-amber-400 font-medium">
                    • Tarif BBM
                  </Link>
                </div>
              )}
